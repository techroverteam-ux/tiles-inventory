          ...
          {loading ? (
            ...
            <>
              <Table>
                ...
                <TableBody>
                  {inventory.map((item) => (
                    <TableRow key={item.id} className="border-b border-border hover:bg-gray-50 dark:hover:bg-gray-700/50">
                      <TableCell>
                        <div>
                      ...
                      <TableCell>
                        <code className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded text-sm text-foreground">
                          {item.batchNumber}
                        </code>
                      </TableCell>
