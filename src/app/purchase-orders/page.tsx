    ...
    <div className="space-y-6">
      ...
      <Dialog open={showLocationDialog} onOpenChange={setShowLocationDialog}>
        <DialogContent className="bg-white dark:bg-gray-800">
          <DialogHeader>
            <DialogTitle className="text-gray-900 dark:text-gray-100">Select Delivery Location</DialogTitle>
          </DialogHeader>
      ...
      <Dialog open={showViewDialog} onOpenChange={setShowViewDialog}>
        <DialogContent className="bg-white dark:bg-gray-800">
          <DialogHeader>
            <DialogTitle className="text-gray-900 dark:text-gray-100">View Purchase Order</DialogTitle>
          </DialogHeader>
          {selectedOrder && (
            <div className="space-y-4">
              ...
              <div className="text-gray-900 dark:text-gray-100"><strong>Expected Date:</strong> {selectedOrder.expectedDate ? new Date(selectedOrder.expectedDate).toLocaleDateString() : 'Not set'}</div>
              <div className="text-gray-900 dark:text-gray-100"><strong>Status:</strong> {selectedOrder.status}</div>
              <div className="text-gray-900 dark:text-gray-100"><strong>Amount:</strong> ₹{selectedOrder.totalAmount.toLocaleString()}</div>
              <div className="text-gray-900 dark:text-gray-100"><strong>Notes:</strong> {selectedOrder.notes || 'No notes'}</div>
            </div>
          )}
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={showEditDialog} onOpenChange={setShowEditDialog}>
        <DialogContent className="max-w-4xl bg-white dark:bg-gray-800">
          <DialogHeader>
            <DialogTitle className="text-gray-900 dark:text-gray-100">Edit Purchase Order</DialogTitle>
          </DialogHeader>
          {selectedOrder && (
            <PurchaseOrderForm 
              order={selectedOrder}
