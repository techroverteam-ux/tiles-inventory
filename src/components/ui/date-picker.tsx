...
export function DatePicker({
  ...
  return (
    <div ref={containerRef} className={cn('relative w-full', className)}>
      ...
      {/* Dropdown calendar — inline, no Portal */}
      {open && (
        <div className="absolute top-[calc(100%+6px)] left-0 z-[200] w-72 rounded-3xl border border-border bg-popover/95 p-5 shadow-premium backdrop-blur-xl animate-in fade-in zoom-in-95 duration-200">
          {/* Month nav */}
