    ...
    <ThemeProvider>
      <ToastProvider>
        ...
        <div className="min-h-screen bg-background text-foreground flex flex-col">
          {/* Header */}
          <header className="bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/90 border-b border-border px-3 sm:px-4 md:px-6 py-3 sm:py-4 flex items-center justify-between fixed top-0 left-0 right-0 z-50 shadow-sm">
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              <Button variant="outline" size="sm" className="hidden sm:flex text-xs px-3 py-2">
